 ...
 * @author Joaquín
 */
public class FichaProductoAutorizadoController implements Initializable {
    ...
    Sonido noAutorizadoEliminarProducto = new Sonido();
    Sonido noAutorizadoModificarProducto = new Sonido();
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       articulo = MdPrincipalAutorizadoController.articulo;
    ...
    private void ModificarArticulo(ActionEvent event) {
        ...
        noAutorizadoModificarProducto.SonidonoAutorizadoModificarProducto();
        
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setHeaderText(null);
        alert.setTitle("Informacion");
        alert.setContentText("No está autorizado para modificar el artículo.\nConsulte con el administrador.");
        alert.showAndWait();
    ...
    private void EliminarArticulo(ActionEvent event) {
        ...
        noAutorizadoEliminarProducto.SonidonoAutorizadoEliminarProducto();
        
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setHeaderText(null);
        alert.setTitle("Informacion");
        alert.setContentText("No está autorizado para eliminar artículos.\nConsulte con el administrador.");
        alert.showAndWait();
